...
## Worked example — Contoso Outdoor Search

A filled-in agenda for the Contoso Outdoor Search sample (see
`samples/contoso-outdoor-search-workshop/agenda.md`):

```text
### Data to be used by SKILL.md to create the Workshop App

- Welcome and engagement framing: Set the business context for Contoso Outdoor...
- Member journeys today: Walk through three real (anonymized) call types...
- The Search concept: Introduce the copilot pattern...
